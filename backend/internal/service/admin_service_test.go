...
func TestAdminService_ListReports(t *testing.T) {
	...
	svc := NewAdminService(reportRepo, &mockAuditLogRepository{}, &mockAdminStatsRepository{})
...
func TestAdminService_ReviewReport_DoesNotWriteAuditLog(t *testing.T) {
	...
	svc := NewAdminService(reportRepo, auditRepo, &mockAdminStatsRepository{})
...
func TestAdminService_Stats(t *testing.T) {
	...
	svc := NewAdminService(&mockReportRepository{}, &mockAuditLogRepository{}, statsRepo)
...
func TestAdminService_AuditLogs(t *testing.T) {
	...
	svc := NewAdminService(&mockReportRepository{}, auditRepo, &mockAdminStatsRepository{})
